		...
		>
			<div className={styles["CtaModal-head"]}>
				<div className={styles["CtaModal-head-text"]}>
					...
					<div className={styles["CtaModal-title"]}>{t("dashboard.insights_panel.new_insights")}</div>
				</div>
				<div
			...
			<div className={styles["CtaModal-body"]}>
				<p className={styles["CtaModal-description"]}>
					{t("dashboard.insights_panel.discover_new_health_insights")}
				</p>
			</div>
			<button className={styles["CtaModal-button"]}>
				<p className={styles["CtaModal-button-text"]}>{t("dashboard.insights_panel.order_dna_test")}</p>
